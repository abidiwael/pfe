...
<body>
    <div class="container">
        <h1 style="font-size:20pt">COMPTES D'ENTREPRISES</h1>

        <h3>Données Entreprises</h3>
        <br />
        <button class="btn btn-success" onclick="add_entreprise()"><i class="glyphicon glyphicon-plus"></i> Ajouter Entreprise</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('entreprises/ajax_list')?>",
            "type": "POST"
        },
...
function add_entreprise()
{
    ...
    $('.modal-title').text('Add Entreprise'); // Set Title to Bootstrap modal title
...
function edit_entreprise(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('entreprises/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Edit entreprise'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('entreprises/ajax_add')?>";
    } else {
        url = "<?php echo site_url('entreprises/ajax_update')?>";
    }
...
function delete_entreprise(id)
{
    if(confirm('Voulez-vous vraiment supprimer ces données?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('entreprises/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Entreprise Form</h3>
            </div>
